...
class FavoritesScreen extends StatelessWidget {
  const FavoritesScreen({super.key, this.onContactTap});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (favorites.isEmpty) return const _FavoritesEmptyState();
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _FavoriteCard(
              ...
              onRemoveFavorite: () => controller.toggleFavorite(contact),
            );
          },
        );
      }),
...
class _FavoriteAvatar extends StatelessWidget {
  const _FavoriteAvatar({required this.contact, this.radius = 24});
              ...
              child: Row(
                children: [
                  Hero(
                    ...
                    child: _FavoriteAvatar(contact: contact, radius: 24),
                  ),
